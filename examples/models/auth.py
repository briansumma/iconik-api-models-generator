...
class TokenSchema(BaseModel):
    ...
    auth_system_domains: Optional[List['MultiDomainUserSystemSchema']
...
class TokenMultiplatformLoginSchema(BaseModel):
    ...
    app_id: Optional[UUID] = None
    auth_system_domains: Optional[List['MultiPlatformDomainUserSystemSchema']
                                  ] = Field(default_factory=list)
    date_created: Optional[datetime] = None
    date_modified: Optional[datetime] = None
    expires: Optional[datetime] = None
...
class SystemDomainSuperAdminSchema(BaseModel):
    ...
    creating_user_id: Optional[UUID] = None
...
class ReferralCodeSchema(BaseModel):
    ...
    is_plg: Optional[bool] = None
    manage_system_domain_id: Optional[UUID] = None
    ordway_customer_id: Optional[str] = None
    sales_force_id: Optional[str] = None
    valid_to: datetime
    value: float
...
class OneloginSettingsSchema(BaseModel):
    ...
    cert_fingerprint_algorithm: Optional[
        Literal['http://www.w3.org/2000/09/xmldsig#sha1',
                'http://www.w3.org/2001/04/xmlenc#sha256',
                'http://www.w3.org/2001/04/xmldsig-more#sha384',
                'http://www.w3.org/2001/04/xmlenc#sha512']] = None
    ...
    signature_algorithm: Optional[
        Literal['http://www.w3.org/2000/09/xmldsig#dsa-sha1',
                'http://www.w3.org/2000/09/xmldsig#rsa-sha1',
                'http://www.w3.org/2001/04/xmldsig-more#rsa-sha256',
                'http://www.w3.org/2001/04/xmldsig-more#rsa-sha384',
                'http://www.w3.org/2001/04/xmldsig-more#rsa-sha512']] = None
...
class NotifySystemDomainOTPConfigurationChangedSchema(BaseModel):
    """Represents a NotifySystemDomainOTPConfigurationChangedSchema in the Iconik system."""
...
class MultiPlatformDomainUserSystemSchema(BaseModel):
    ...
    mfa_methods_configured: Optional[List[Literal['TOTP', 'MAIL_2SV']]
                                     ] = Field(default_factory=list)
...
class MultiDomainUserSystemsSchema(BaseModel):
    ...
    last_url: Optional[str] = None
    next_url: Optional[str] = None
    objects: Optional[List['MultiDomainUserSystemSchema']
                      ] = Field(default_factory=list)
    page: Optional[int] = Field(None, ge=-2147483648, le=2147483647)
    pages: Optional[int] = Field(None, ge=-2147483648, le=2147483647)
    per_page: Optional[int] = Field(None, ge=-2147483648, le=2147483647)
...
class IdentityProvidersSchema(BaseModel):
    ...
    last_url: Optional[str] = None
    next_url: Optional[str] = None
    objects: Optional[List['IdentityProviderSchema']
                      ] = Field(default_factory=list)
    page: Optional[int] = Field(None, ge=-2147483648, le=2147483647)
    pages: Optional[int] = Field(None, ge=-2147483648, le=2147483647)
    per_page: Optional[int] = Field(None, ge=-2147483648, le=2147483647)
